...
## Steps
1. Read `_ux-ui-shared/workflows/prototyping.md` (5-level fidelity ladder, journey mapping template, usability-testing script, sample data).
...
5. High-fi/code steps pull tokens (`_ux-ui-shared/tokens/*`), components (`_ux-ui-shared/components/*`), taste (`_ux-ui-shared/taste/*`), and a11y (`_ux-ui-shared/accessibility/*`).
