...
## Steps
1. Read `_ux-ui-shared/workflows/design-review.md` (rubric, scoring guide, Nielsen heuristics, process).
...
4. Run the accessibility lens with `_ux-ui-shared/accessibility/wcag-checklist.md`; use `_ux-ui-shared/scripts/contrast.py` for any color-pair doubts.
5. Check against the anti-slop tells in `_ux-ui-shared/taste/design-taste.md` (Banned Defaults checklist).
